...
function $createKeywordNode_(textNode: TextNode): KeywordNode {
  return $createKeywordNode(textNode.getTextContent());
}

export const KeywordsExtension = defineExtension({
  name: "@initiative/keywords",
  nodes: [KeywordNode],
  register: (editor) =>
    mergeRegister(
      ...registerLexicalTextEntity(editor, getKeywordMatch, KeywordNode, $createKeywordNode_)
    ),
});
