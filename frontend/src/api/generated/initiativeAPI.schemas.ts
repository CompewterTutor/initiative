...
export type AccountDeletionRequestProjectTransfers = {
  [key: string]: number;
} | null;
...
export type AdminUserDeleteRequestProjectTransfers = {
  [key: string]: number;
} | null;
...
export type GetLatestDockerhubVersionApiV1VersionLatestGet200 = {
...
export type BootstrapStatusApiV1AuthBootstrapGet200 = {
  [key: string]: boolean;
};
...
export type SendTestEmailApiV1SettingsEmailTestPost200 = {
  [key: string]: unknown;
};
...
export type ListQueuePermissionsApiV1QueuesQueueIdPermissionsGet200 = {
  [key: string]: unknown;
};
